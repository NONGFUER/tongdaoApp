			...
			for ( var j = 0; j < paramstrarr.length; j++) {
				...
				if (paramstr != null) {
					...
					str += "<div class='policyAdress_status'>";
					 if( defaultflag == 2){
					 str += "<div class='chooseIcon'><img alt='chooseImage' src='../../../image/insurance/car/gouxuan2.png'></div><div class='address_default'>默认地址</div>";
					 }else{
                    ...
                    str += "<div class='policyAdress_option toDelete'><input type='hidden' value='"+ recAddressId +"'><div class='deleteIcon'><img src='../../../image/insurance/car/delete.png'/></div><span></span></div>";
                    str += "<div class='policyAdress_option toEdit'><input type='hidden' id='toEdit' value='"+j+"'><div class='modifyimg'><img src='../../../image/insurance/car/alter.png'/></div><span></span></div>";
                    str += "</div>"
