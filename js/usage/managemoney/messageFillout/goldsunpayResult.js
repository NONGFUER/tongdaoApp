...
$(function() {
	...
	function getYgOrderInform(data) {
		...
		if(data.statusCode == '000000') {
			...
			vm.policyNo=data.returns.financeOrder.policyNo;
			huifang();
		}
	}
	/**--返回--*/
...
function huifang() {
	...
	function getYgToken(data) {
		...
		if(data.statusCode == '000000') {
			...
			vm.urlParm.policyNo=vm.policyNo;
